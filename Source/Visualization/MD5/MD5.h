...
UCLASS()
class VISUALIZATION_API Amd5 : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	static std::string Encode(std::string src_info);
	...
	//MD5加密
	UFUNCTION(Blueprintpure, Category = md5)
		static FString encodeMD5(FString string);
